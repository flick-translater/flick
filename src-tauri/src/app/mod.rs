...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::capture::finish_gif_recording,
            commands::capture::finish_recording,
            commands::capture::cancel_gif_recording,
            commands::capture::cancel_recording,
            commands::capture::set_gif_recording_window_shape,
            commands::capture::set_recording_window_mode,
            commands::capture::open_gif_recording_toolbar_window,
